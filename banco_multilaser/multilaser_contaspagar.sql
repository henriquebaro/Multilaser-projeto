...
CREATE TABLE `contaspagar` (
  ...
  `EmissaoFatura` datetime DEFAULT CURRENT_TIMESTAMP,
  `VencimentoFatura` datetime DEFAULT NULL,
  `FaturaValor` decimal(10,2) DEFAULT NULL,
  `StatusFatura` varchar(50) DEFAULT NULL,
